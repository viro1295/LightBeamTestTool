...
stack_memory_addCMD_checkbutton.grid(row=3, column=3, sticky='w')
...
iteration_addCMD_checkbutton.grid(row=4, column=3, sticky='w')
...
disable_shortcuts_addCMD_checkbutton.grid(row=5, column=3, sticky='w')
...
threads_number_addCMD_checkbutton.grid(row=6, column=3, sticky='w')
...
stop_after_addCMD_checkbutton.grid(row=7, column=3, sticky='w')
...
progressive_slice_height_addCMD_checkbutton.grid(row=8, column=3, sticky='w')
...
decode_timeout_addCMD_checkbutton.grid(row=9, column=3, sticky='w')
...
progressive_instances_number_addCMD_checkbutton.grid(row=10, column=3, sticky='w')
...
repeat_addCMD_checkbutton.grid(row=11, column=3, sticky='w')
...
verbose_addCMD_checkbutton.grid(row=12, column=3, sticky='w')
