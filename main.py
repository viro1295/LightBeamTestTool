...
file_menu.add_command(label="Load Settings", command=lambda: load_settings(message_label, lightbeam_label, configure_label, resultfolder_label, imagefolder_label))
file_menu.add_command(label="Save Settings", command=lambda: save_settings(message_label, lightbeam_label.cget("text"), configure_label.cget("text"), resultfolder_label.cget("text"), imagefolder_label.cget("text")))
...
run_menu.add_command(label="Create CSV TestSuite", command=lambda: create_csv_testsuite(message_label))
...
analyze_menu.add_command(label="Compare Results", command=lambda: compare_results(message_label))
