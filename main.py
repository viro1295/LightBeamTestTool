...
hogfile_checkbutton = tk.Checkbutton(parameterframe, text="Hog File: ", variable=hogfile_tick, command=lambda: toggle_widgetstate(message_label, hogfile_tick, hogfile_inputbox, hogfile_browsebutton))
...
hogfile_addCMD_checkbutton = tk.Checkbutton(parameterframe, text="Add CMD", variable=hogfile_addCMD_tick, command=lambda: check_addtoCMD_entrybox(message_label, hogfile_addCMD_tick, hogfile_addCMD_checkbutton))
hogfile_addCMD_checkbutton.grid(row=0, column=3, sticky='w')

log_tick = tk.BooleanVar()
log_checkbutton = tk.Checkbutton(parameterframe, text="Enable Logging: ", variable=log_tick, command=lambda: toggle_widgetstate(message_label, log_tick, log_inputbox, log_browsebutton))
...
log_addCMD_checkbutton = tk.Checkbutton(parameterframe, text="Add CMD", variable=log_addCMD_tick, command=lambda: check_addtoCMD_entrybox(message_label, log_addCMD_tick, log_addCMD_checkbutton))
