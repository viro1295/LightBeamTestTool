...
loglevel_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, loglevel_combobox, loglevel_label, "0", loglevel_addCMD_tick, loglevel_addCMD_checkbutton))
...
heap_memory_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, heap_memory_combobox, heap_memory_label, "10000", heap_memory_addCMD_tick, heap_memory_addCMD_checkbutton))
...
stack_memory_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, stack_memory_combobox, stack_memory_label, "11000", stack_memory_addCMD_tick, stack_memory_addCMD_checkbutton))
...
iteration_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, iteration_combobox, iteration_label, "1", iteration_addCMD_tick, iteration_addCMD_checkbutton))
...
threads_number_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, threads_number_combobox, threads_number_label, "1", threads_number_addCMD_tick, threads_number_addCMD_checkbutton))
...
stop_after_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, stop_after_combobox, stop_after_label, "1", stop_after_addCMD_tick, stop_after_addCMD_checkbutton))
...
progressive_slice_height_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, progressive_slice_height_combobox, progressive_slice_height_label, "256", progressive_slice_height_addCMD_tick, progressive_slice_height_addCMD_checkbutton))
...
decode_timeout_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, decode_timeout_combobox, decode_timeout_label, "-1", decode_timeout_addCMD_tick, decode_timeout_addCMD_checkbutton))
...
progressive_instances_number_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, progressive_instances_number_combobox, progressive_instances_number_label, "1", progressive_instances_number_addCMD_tick, progressive_instances_number_addCMD_checkbutton))
...
repeat_combobox.bind("<<ComboboxSelected>>", lambda event: setstate_combobox(message_label, event, repeat_combobox, repeat_label, "1", repeat_addCMD_tick, repeat_addCMD_checkbutton))
